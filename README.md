...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/weathered-lake-ab67#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/weathered-lake-ab67
```

A live public deployment of this template is available at [https://weathered-lake-ab67.templates.workers.dev](https://weathered-lake-ab67.templates.workers.dev)
